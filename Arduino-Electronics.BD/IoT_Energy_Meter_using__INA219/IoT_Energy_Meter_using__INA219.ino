...
#define BLYNK_TEMPLATE_ID "TMPLvMJN913d"
#define BLYNK_DEVICE_NAME "IOT Energy Meter"

#include <ESP8266WiFi.h>
#include <BlynkSimpleEsp8266.h>
#include <SoftwareSerial.h>
#define BLYNK_AUTH_TOKEN "6zmICzLhWSMdcF7_kILvHr9Ft3xzWUGq"
char auth[] = "6zmICzLhWSMdcF7_kILvHr9Ft3xzWUGq";
...
void ina219values()  {
  ...
  Blynk.virtualWrite(V5, String("Tk.") + String(energyPrice) );
  ...
  Serial.print("Energy Cost:   "); Serial.print("Tk. "); Serial.println(energyCost);
  Serial.println("-------------------------");
}
void displaydata() {
  display.clearDisplay();
  ...
  // ENERGY COST
  Blynk.virtualWrite(V6, String("Tk.") + String(energyCost, 5) );
  display.setCursor(10, 54);
  display.print("E Cost:Tk ");
