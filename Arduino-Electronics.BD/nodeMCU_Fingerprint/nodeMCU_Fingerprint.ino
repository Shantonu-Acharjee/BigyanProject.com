...
//************************************************************************
SoftwareSerial mySerial(Finger_Rx, Finger_Tx, false, 256);
Adafruit_Fingerprint finger = Adafruit_Fingerprint(&mySerial);
//************************************************************************
/* Set these to your desired credentials. */
const char *ssid = "Sarah";  //ENTER YOUR WIFI SETTINGS
const char *password = "abcd1234efgh";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "https://electronics.com.bd/attendance/getdata.php"; //computer IP or the server domain
