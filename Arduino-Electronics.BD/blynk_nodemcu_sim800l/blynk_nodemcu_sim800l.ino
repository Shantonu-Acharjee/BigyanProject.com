...
//------------------------------------------------------------------
#define BLYNK_TEMPLATE_ID "TMPLFmMJ58bg"
#define BLYNK_DEVICE_NAME "IOT GSM"
#define BLYNK_AUTH_TOKEN "A_IrJFFpwNwTykKwqwGqifgWKTkgBL5u"
//------------------------------------------------------------------
...
const String PHONE = "+8801780166164";
//------------------------------------------------------------------
#define pin_relay1 D0
#define pin_relay2 D8
#define pin_relay3 D2
#define pin_relay4 D1
//------------------------------------------------------------------
int state_relay1 = 1;
int state_relay2 = 1;
int state_relay3 = 1;
