...
int relay = 0;
const char* mqtt_server = "192.168.0.112"; // Add your IP here (IP of device where you installed Home Assistant)
...
WiFi.begin("Sarah","abcd1234efgh"); // Add your Wi-Fi name and password here
