...
int stop =0, mode=0, flag=0, buzzer_flag=0, alarm_flag=0;
...
//Timer1 ON
if (timer1==1 && alarmMode==1 && hh==Start1HH && mm==Start1MM && buzzer_flag==0)  {digitalWrite(drawer1, HIGH); digitalWrite(buzzer, HIGH); delay (200); alarm_flag=1;}
//Timer1 OFF
if (timer1==1 && alarmMode==1 && hh==Finish1HH && mm==Finish1MM){digitalWrite(drawer1, LOW); buzzer_flag=0; alarm_flag=0;}

//Timer2 ON
if (timer2==1 && alarmMode==1 && hh==Start2HH && mm==Start2MM && buzzer_flag==0)  {digitalWrite(drawer2, HIGH); digitalWrite(buzzer, HIGH); delay (200); alarm_flag=1;}
//Timer2 OFF
if (timer2==1 && alarmMode==1 && hh==Finish2HH && mm==Finish2MM){digitalWrite(drawer2, LOW); buzzer_flag=0; alarm_flag=0;}

//Timer3 ON
if (timer3==1 && alarmMode==1 && hh==Start3HH && mm==Start3MM && buzzer_flag==0)  {digitalWrite(drawer3, HIGH); digitalWrite(buzzer, HIGH); delay (200); alarm_flag=1;}
//Timer3 OFF
if (timer3==1 && alarmMode==1 && hh==Finish3HH && mm==Finish3MM){digitalWrite(drawer3, LOW); buzzer_flag=0; alarm_flag=0;}

//Timer4 ON
if (timer4==1 && alarmMode==1 && hh==Start4HH && mm==Start4MM && buzzer_flag==0)  {digitalWrite(buzzer, HIGH); delay (200); alarm_flag=01;}
//Timer4 OFF
if (timer4==1 && alarmMode==1 && hh==Finish4HH && mm==Finish4MM){ buzzer_flag=0; alarm_flag=0;}
